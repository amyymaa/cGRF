function cd2m = cd2m(u1, l, a1, a2, coeffs, g1, g2)
% u1: input locations (x and x' in writing)
% l: lengthscale, prior precision
% a1, a2: boundary locations
% coeffs: [c11, c12, c21, c22, g1, g2], coefficients for mixed boundary constraints

u1 = reshape(u1, length(u1), 1);
[d2u1w1, d2u1w2] = d2W(u1, l, a1, a2, coeffs);

cd2m = d2u1w1 .* g1 + d2u1w2 .* g2;
